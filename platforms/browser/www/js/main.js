...
Q.scene('stages',function(stage){
	...
	addButton(stage,305,610,'geniusbtn.png',function(){
		Q.audio.stop();
		Q.load('backbtn.png,quiz/addbg.png,quiz/subtractbg.png,quiz/multiplybg.png,quiz/divisionbg.png,cupcake/box1.png,cupcake/box2.png,cupcake/box3.png,cupcake/box4.png,cupcake/box5.png,cupcake/box6.png,cupcake/box7.png,cupcake/box8.png,cupcake/box9.png,tutorials/squares.png',function(){
			Q.stageScene('genius');
		});
	});
});
...
function generateGiven(stage,op,level){
	...
	if(op == 0){
		...
		third =  new Q.UI.Button({
			...
			if(first.p.opacity == 1 && second.p.opacity == 1){
				Q.audio.play('banana.mp3');
				this.p.opacity = 1;
				addSprite(stage,305,670,'tutorials/squares.png');
				generateRandomChoices(stage,given1 * given2,level);
